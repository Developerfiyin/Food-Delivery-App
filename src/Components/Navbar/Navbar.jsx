...
const Navbar = () => {
  ...
  return (
    <div className=" w-full h-25 bg-slate-200 flex justify-between px-6 items-center md:px-8 ">
      ...
      <form
        className="flex  items-center shadow-md h-15 w-[45%] gap-5 bg-white px-5 py-2 rounded-md"
      ...
      <div
        className=" h-15 w-15 bg-white flex relative cursor-pointer justify-center items-center rounded-md"
        onClick={() => setShowcart(true)}
      >
        <span className="absolute top-0 right-2 font-bold text-purple-400 text-[18px]">
          {items.length}{" "}
        </span>
